...
"; then
        echo "[aeneas-lean-oracle] all partial signals in external deps — suppressed per §六 当前 crate 焦点" >&2
    else
        echo "[aeneas-lean-oracle] FAIL: partial signal in entry crate or no source path" >&2
